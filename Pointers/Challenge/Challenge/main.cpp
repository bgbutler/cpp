...
/************
 This function expects:
  ...
  size2 - the number of intergers in arr2

 
  The function dynamically allocates a new arrate that is 
  of size = size1 * size 2  Then it loops through each element of arr2 and 
  multiplies is across all the elements of arr1 and each product is 
  stored in the newly created array
*************************************/
